///
/// @file Scalar3DUpdater7.h
/// @brief スカラデータクラス仮想セルアップデータ
///

#ifndef SCALAR_3D_UPDATER7_H
#define SCALAR_3D_UPDATER7_H
...
namespace BCMT_NAMESPACE {
	...
	///
	template <typename T>
		class Scalar3DUpdater7 : public VCUpdater {
			...
			public:
				...
				///
				Scalar3DUpdater7(const NeighborInfo* neighborInfo,
...
#pragma omp parallel for collapse(3)
	...
	template <>
		void Scalar3DUpdater7<real>::copyFromNeighbor(Face face);
	template <>
		void Scalar3DUpdater7<real>::copyFromNeighborC2F(Face face, Subface subface);
	template <>
		void Scalar3DUpdater7<real>::copyFromNeighborF2C(Face face, Subface subface);
	template <>
		void Scalar3DUpdater7<real>::copyFromCommBuffer(Face face);
	template <>
		void Scalar3DUpdater7<real>::copyFromCommBufferC2F(Face face, Subface subface);
	template <>
		void Scalar3DUpdater7<real>::copyFromCommBufferF2C(Face face, Subface subface);
	template <>
		void Scalar3DUpdater7<real>::copyToCommBuffer(Face face);
	template <>
		void Scalar3DUpdater7<real>::copyToCommBufferC2F(Face face, Subface subface);
	template <>
		void Scalar3DUpdater7<real>::copyToCommBufferF2C(Face face, Subface subface);
